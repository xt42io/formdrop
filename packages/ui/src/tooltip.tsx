/**
 * Hover tooltip, portalled to document.body so it escapes any ancestor with
 * `overflow: hidden` and flips above/below depending on the space available.
 *
 * Moved here from apps/web unchanged: <Button requiresPro> renders one, so it
 * had to come along, and the docs site will want it too.
 */
